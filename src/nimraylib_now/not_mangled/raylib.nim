...
type
  Wave* {.bycopy.} = object
    sampleCount*: cuint        ##  Total number of samples (considering channels!)
...
type
  VrDeviceInfo* {.bycopy.} = object
    ...
    lensDistortionValues*: array[4, cfloat] ##  Lens distortion constant parameters
    chromaAbCorrection*: array[4, cfloat] ##  Chromatic aberration correction parameters
...
type
  VrStereoConfig* {.bycopy.} = object
    ...
    leftLensCenter*: array[2, cfloat] ##  VR left lens center
    rightLensCenter*: array[2, cfloat] ##  VR right lens center
    leftScreenCenter*: array[2, cfloat] ##  VR left screen center
    rightScreenCenter*: array[2, cfloat] ##  VR right screen center
    scale*: array[2, cfloat]    ##  VR distortion scale
    scaleIn*: array[2, cfloat]  ##  VR distortion scale in
...
proc initWindow*(width: cint; height: cint; title: cstring) {.cdecl,
    importc: "InitWindow", dynlib: dynlibLibraryName.}
...
proc closeWindow*() {.cdecl, importc: "CloseWindow", dynlib: dynlibLibraryName.}
...
proc maximizeWindow*() {.cdecl, importc: "MaximizeWindow", dynlib: dynlibLibraryName.}
##  Set window state: maximized, if resizable (only PLATFORM_DESKTOP)

proc minimizeWindow*() {.cdecl, importc: "MinimizeWindow", dynlib: dynlibLibraryName.}
##  Set window state: minimized, if resizable (only PLATFORM_DESKTOP)

proc restoreWindow*() {.cdecl, importc: "RestoreWindow", dynlib: dynlibLibraryName.}
...
proc setWindowMinSize*(width: cint; height: cint) {.cdecl,
    importc: "SetWindowMinSize", dynlib: dynlibLibraryName.}
...
proc getMonitorPosition*(monitor: cint): Vector2 {.cdecl,
    importc: "GetMonitorPosition", dynlib: dynlibLibraryName.}
...
proc getMonitorPhysicalWidth*(monitor: cint): cint {.cdecl,
    importc: "GetMonitorPhysicalWidth", dynlib: dynlibLibraryName.}
##  Get specified monitor physical width in millimetres

proc getMonitorPhysicalHeight*(monitor: cint): cint {.cdecl,
    importc: "GetMonitorPhysicalHeight", dynlib: dynlibLibraryName.}
##  Get specified monitor physical height in millimetres

proc getMonitorRefreshRate*(monitor: cint): cint {.cdecl,
    importc: "GetMonitorRefreshRate", dynlib: dynlibLibraryName.}
...
proc showCursor*() {.cdecl, importc: "ShowCursor", dynlib: dynlibLibraryName.}
##  Shows cursor

proc hideCursor*() {.cdecl, importc: "HideCursor", dynlib: dynlibLibraryName.}
##  Hides cursor
...
proc enableCursor*() {.cdecl, importc: "EnableCursor", dynlib: dynlibLibraryName.}
##  Enables cursor (unlock cursor)

proc disableCursor*() {.cdecl, importc: "DisableCursor", dynlib: dynlibLibraryName.}
...
proc beginDrawing*() {.cdecl, importc: "BeginDrawing", dynlib: dynlibLibraryName.}
##  Setup canvas (framebuffer) to start drawing

proc endDrawing*() {.cdecl, importc: "EndDrawing", dynlib: dynlibLibraryName.}
...
proc endMode2D*() {.cdecl, importc: "EndMode2D", dynlib: dynlibLibraryName.}
...
proc endMode3D*() {.cdecl, importc: "EndMode3D", dynlib: dynlibLibraryName.}
##  Ends 3D mode and returns to default 2D orthographic mode

proc beginTextureMode*(target: RenderTexture2D) {.cdecl,
    importc: "BeginTextureMode", dynlib: dynlibLibraryName.}
##  Initializes render texture for drawing

proc endTextureMode*() {.cdecl, importc: "EndTextureMode", dynlib: dynlibLibraryName.}
...
proc endShaderMode*() {.cdecl, importc: "EndShaderMode", dynlib: dynlibLibraryName.}
...
proc endBlendMode*() {.cdecl, importc: "EndBlendMode", dynlib: dynlibLibraryName.}
##  End blending mode (reset to default: alpha blending)

proc beginScissorMode*(x: cint; y: cint; width: cint; height: cint) {.cdecl,
    importc: "BeginScissorMode", dynlib: dynlibLibraryName.}
##  Begin scissor mode (define screen area for following drawing)

proc endScissorMode*() {.cdecl, importc: "EndScissorMode", dynlib: dynlibLibraryName.}
##  End scissor mode

proc beginVrStereoMode*(config: VrStereoConfig) {.cdecl,
    importc: "BeginVrStereoMode", dynlib: dynlibLibraryName.}
...
proc getMouseRay*(mousePosition: Vector2; camera: Camera): Ray {.cdecl,
    importc: "GetMouseRay", dynlib: dynlibLibraryName.}
...
proc getFPS*(): cint {.cdecl, importc: "GetFPS", dynlib: dynlibLibraryName.}
##  Returns current FPS
...
proc getTime*(): cdouble {.cdecl, importc: "GetTime", dynlib: dynlibLibraryName.}
...
proc memAlloc*(size: cint): pointer {.cdecl, importc: "MemAlloc",
                                  dynlib: dynlibLibraryName.}
...
proc saveFileData*(fileName: cstring; data: pointer; bytesToWrite: cuint): bool {.cdecl,
    importc: "SaveFileData", dynlib: dynlibLibraryName.}
...
proc saveFileText*(fileName: cstring; text: cstring): bool {.cdecl,
    importc: "SaveFileText", dynlib: dynlibLibraryName.}
...
proc isFileExtension*(fileName: cstring; ext: cstring): bool {.cdecl,
    importc: "IsFileExtension", dynlib: dynlibLibraryName.}
##  Check file extension (including point: .png, .wav)

proc getFileExtension*(fileName: cstring): cstring {.cdecl,
    importc: "GetFileExtension", dynlib: dynlibLibraryName.}
...
proc getFileNameWithoutExt*(filePath: cstring): cstring {.cdecl,
    importc: "GetFileNameWithoutExt", dynlib: dynlibLibraryName.}
##  Get filename string without extension (uses static string)

proc getDirectoryPath*(filePath: cstring): cstring {.cdecl,
    importc: "GetDirectoryPath", dynlib: dynlibLibraryName.}
##  Get full path for a given fileName with path (uses static string)

proc getPrevDirectoryPath*(dirPath: cstring): cstring {.cdecl,
    importc: "GetPrevDirectoryPath", dynlib: dynlibLibraryName.}
...
proc getDirectoryFiles*(dirPath: cstring; count: ptr cint): cstringArray {.cdecl,
    importc: "GetDirectoryFiles", dynlib: dynlibLibraryName.}
...
proc getDroppedFiles*(count: ptr cint): cstringArray {.cdecl,
    importc: "GetDroppedFiles", dynlib: dynlibLibraryName.}
##  Get dropped files names (memory should be freed)

proc clearDroppedFiles*() {.cdecl, importc: "ClearDroppedFiles",
                          dynlib: dynlibLibraryName.}
...
proc openURL*(url: cstring) {.cdecl, importc: "OpenURL", dynlib: dynlibLibraryName.}
...
proc isKeyUp*(key: cint): bool {.cdecl, importc: "IsKeyUp", dynlib: dynlibLibraryName.}
##  Detect if a key is NOT being pressed

proc setExitKey*(key: cint) {.cdecl, importc: "SetExitKey", dynlib: dynlibLibraryName.}
...
proc isGamepadName*(gamepad: cint; name: cstring): bool {.cdecl,
    importc: "IsGamepadName", dynlib: dynlibLibraryName.}
...
proc isGamepadButtonPressed*(gamepad: cint; button: cint): bool {.cdecl,
    importc: "IsGamepadButtonPressed", dynlib: dynlibLibraryName.}
##  Detect if a gamepad button has been pressed once

proc isGamepadButtonDown*(gamepad: cint; button: cint): bool {.cdecl,
    importc: "IsGamepadButtonDown", dynlib: dynlibLibraryName.}
##  Detect if a gamepad button is being pressed

proc isGamepadButtonReleased*(gamepad: cint; button: cint): bool {.cdecl,
    importc: "IsGamepadButtonReleased", dynlib: dynlibLibraryName.}
##  Detect if a gamepad button has been released once

proc isGamepadButtonUp*(gamepad: cint; button: cint): bool {.cdecl,
    importc: "IsGamepadButtonUp", dynlib: dynlibLibraryName.}
...
proc getGamepadAxisCount*(gamepad: cint): cint {.cdecl,
    importc: "GetGamepadAxisCount", dynlib: dynlibLibraryName.}
##  Return gamepad axis count for a gamepad

proc getGamepadAxisMovement*(gamepad: cint; axis: cint): cfloat {.cdecl,
    importc: "GetGamepadAxisMovement", dynlib: dynlibLibraryName.}
##  Return axis movement value for a gamepad axis

proc setGamepadMappings*(mappings: cstring): cint {.cdecl,
    importc: "SetGamepadMappings", dynlib: dynlibLibraryName.}
##  Set internal gamepad mappings (SDL_GameControllerDB)
##  Input-related functions: mouse

proc isMouseButtonPressed*(button: cint): bool {.cdecl,
    importc: "IsMouseButtonPressed", dynlib: dynlibLibraryName.}
...
proc isMouseButtonReleased*(button: cint): bool {.cdecl,
    importc: "IsMouseButtonReleased", dynlib: dynlibLibraryName.}
...
proc getMouseX*(): cint {.cdecl, importc: "GetMouseX", dynlib: dynlibLibraryName.}
##  Returns mouse position X

proc getMouseY*(): cint {.cdecl, importc: "GetMouseY", dynlib: dynlibLibraryName.}
...
proc getTouchX*(): cint {.cdecl, importc: "GetTouchX", dynlib: dynlibLibraryName.}
##  Returns touch position X for touch point 0 (relative to screen size)

proc getTouchY*(): cint {.cdecl, importc: "GetTouchY", dynlib: dynlibLibraryName.}
...
proc setCameraSmoothZoomControl*(keySmoothZoom: cint) {.cdecl,
    importc: "SetCameraSmoothZoomControl", dynlib: dynlibLibraryName.}
...
proc setCameraMoveControls*(keyFront: cint; keyBack: cint; keyRight: cint;
    ...
    importc: "SetCameraMoveControls", dynlib: dynlibLibraryName.}
...
proc setShapesTexture*(texture: Texture2D; source: Rectangle) {.cdecl,
    importc: "SetShapesTexture", dynlib: dynlibLibraryName.}
...
proc drawCircleV*(center: Vector2; radius: cfloat; color: Color) {.cdecl,
    importc: "DrawCircleV", dynlib: dynlibLibraryName.}
##  Draw a color-filled circle (Vector version)

proc drawCircleLines*(centerX: cint; centerY: cint; radius: cfloat; color: Color) {.
    cdecl, importc: "DrawCircleLines", dynlib: dynlibLibraryName.}
##  Draw circle outline
...
proc checkCollisionLines*(startPos1: Vector2; endPos1: Vector2; startPos2: Vector2;
    ...
    importc: "CheckCollisionLines", dynlib: dynlibLibraryName.}
##  Check the collision between two lines defined by two points each, returns collision point by reference

proc getCollisionRec*(rec1: Rectangle; rec2: Rectangle): Rectangle {.cdecl,
    importc: "GetCollisionRec", dynlib: dynlibLibraryName.}
...
proc loadImageAnim*(fileName: cstring; frames: ptr cint): Image {.cdecl,
    importc: "LoadImageAnim", dynlib: dynlibLibraryName.}
##  Load image sequence from file (frames appended to image.data)

proc loadImageFromMemory*(fileType: cstring; fileData: ptr uint8; dataSize: cint): Image {.
    cdecl, importc: "LoadImageFromMemory", dynlib: dynlibLibraryName.}
...
proc imageFromImage*(image: Image; rec: Rectangle): Image {.cdecl,
    importc: "ImageFromImage", dynlib: dynlibLibraryName.}
##  Create an image from another image piece

proc imageText*(text: cstring; fontSize: cint; color: Color): Image {.cdecl,
    importc: "ImageText", dynlib: dynlibLibraryName.}
...
proc imageDither*(image: ptr Image; rBpp: cint; gBpp: cint; bBpp: cint; aBpp: cint) {.cdecl,
    importc: "ImageDither", dynlib: dynlibLibraryName.}
...
proc imageColorTint*(image: ptr Image; color: Color) {.cdecl,
    importc: "ImageColorTint", dynlib: dynlibLibraryName.}
...
proc imageColorContrast*(image: ptr Image; contrast: cfloat) {.cdecl,
    importc: "ImageColorContrast", dynlib: dynlibLibraryName.}
##  Modify image color: contrast (-100 to 100)

proc imageColorBrightness*(image: ptr Image; brightness: cint) {.cdecl,
    importc: "ImageColorBrightness", dynlib: dynlibLibraryName.}
##  Modify image color: brightness (-255 to 255)

proc imageColorReplace*(image: ptr Image; color: Color; replace: Color) {.cdecl,
    importc: "ImageColorReplace", dynlib: dynlibLibraryName.}
...
proc loadImagePalette*(image: Image; maxPaletteSize: cint; colorsCount: ptr cint): ptr Color {.
    cdecl, importc: "LoadImagePalette", dynlib: dynlibLibraryName.}
...
proc imageDrawLineV*(dst: ptr Image; start: Vector2; `end`: Vector2; color: Color) {.
    cdecl, importc: "ImageDrawLineV", dynlib: dynlibLibraryName.}
...
proc imageDrawTextEx*(dst: ptr Image; font: Font; text: cstring; position: Vector2;
    ...
    importc: "ImageDrawTextEx", dynlib: dynlibLibraryName.}
...
proc loadTextureFromImage*(image: Image): Texture2D {.cdecl,
    importc: "LoadTextureFromImage", dynlib: dynlibLibraryName.}
##  Load texture from image data

proc loadTextureCubemap*(image: Image; layout: cint): TextureCubemap {.cdecl,
    importc: "LoadTextureCubemap", dynlib: dynlibLibraryName.}
##  Load cubemap from image, multiple image cubemap layouts supported

proc loadRenderTexture*(width: cint; height: cint): RenderTexture2D {.cdecl,
    importc: "LoadRenderTexture", dynlib: dynlibLibraryName.}
...
proc unloadRenderTexture*(target: RenderTexture2D) {.cdecl,
    importc: "UnloadRenderTexture", dynlib: dynlibLibraryName.}
##  Unload render texture from GPU memory (VRAM)

proc updateTexture*(texture: Texture2D; pixels: pointer) {.cdecl,
    importc: "UpdateTexture", dynlib: dynlibLibraryName.}
##  Update GPU texture with new data

proc updateTextureRec*(texture: Texture2D; rec: Rectangle; pixels: pointer) {.cdecl,
    importc: "UpdateTextureRec", dynlib: dynlibLibraryName.}
...
proc drawTextureQuad*(texture: Texture2D; tiling: Vector2; offset: Vector2;
    ...
    importc: "DrawTextureQuad", dynlib: dynlibLibraryName.}
...
proc drawTextureTiled*(texture: Texture2D; source: Rectangle; dest: Rectangle;
    ...
    cdecl, importc: "DrawTextureTiled", dynlib: dynlibLibraryName.}
...
proc drawTexturePro*(texture: Texture2D; source: Rectangle; dest: Rectangle;
    ...
    importc: "DrawTexturePro", dynlib: dynlibLibraryName.}
##  Draw a part of a texture defined by a rectangle with 'pro' parameters

proc drawTextureNPatch*(texture: Texture2D; nPatchInfo: NPatchInfo; dest: Rectangle;
                       origin: Vector2; rotation: cfloat; tint: Color) {.cdecl,
    importc: "DrawTextureNPatch", dynlib: dynlibLibraryName.}
...
proc drawTexturePoly*(texture: Texture2D; center: Vector2; points: ptr Vector2;
    ...
    importc: "DrawTexturePoly", dynlib: dynlibLibraryName.}
...
proc colorFromNormalized*(normalized: Vector4): Color {.cdecl,
    importc: "ColorFromNormalized", dynlib: dynlibLibraryName.}
...
proc colorFromHSV*(hue: cfloat; saturation: cfloat; value: cfloat): Color {.cdecl,
    importc: "ColorFromHSV", dynlib: dynlibLibraryName.}
...
proc colorAlphaBlend*(dst: Color; src: Color; tint: Color): Color {.cdecl,
    importc: "ColorAlphaBlend", dynlib: dynlibLibraryName.}
...
proc loadFontFromImage*(image: Image; key: Color; firstChar: cint): Font {.cdecl,
    importc: "LoadFontFromImage", dynlib: dynlibLibraryName.}
...
proc loadFontFromMemory*(fileType: cstring; fileData: ptr uint8; dataSize: cint;
    ...
    cdecl, importc: "LoadFontFromMemory", dynlib: dynlibLibraryName.}
...
proc loadFontData*(fileData: ptr uint8; dataSize: cint; fontSize: cint;
    ...
    cdecl, importc: "LoadFontData", dynlib: dynlibLibraryName.}
...
proc genImageFontAtlas*(chars: ptr CharInfo; recs: ptr ptr Rectangle; charsCount: cint;
    ...
    importc: "GenImageFontAtlas", dynlib: dynlibLibraryName.}
##  Generate image font atlas using chars info

proc unloadFontData*(chars: ptr CharInfo; charsCount: cint) {.cdecl,
    importc: "UnloadFontData", dynlib: dynlibLibraryName.}
##  Unload font chars info data (RAM)

proc unloadFont*(font: Font) {.cdecl, importc: "UnloadFont", dynlib: dynlibLibraryName.}
...
proc drawText*(text: cstring; posX: cint; posY: cint; fontSize: cint; color: Color) {.
    cdecl, importc: "DrawText", dynlib: dynlibLibraryName.}
...
proc drawTextRec*(font: Font; text: cstring; rec: Rectangle; fontSize: cfloat;
    ...
    importc: "DrawTextRec", dynlib: dynlibLibraryName.}
...
proc measureTextEx*(font: Font; text: cstring; fontSize: cfloat; spacing: cfloat): Vector2 {.
    cdecl, importc: "MeasureTextEx", dynlib: dynlibLibraryName.}
##  Measure string size for Font

proc getGlyphIndex*(font: Font; codepoint: cint): cint {.cdecl,
    importc: "GetGlyphIndex", dynlib: dynlibLibraryName.}
...
proc textIsEqual*(text1: cstring; text2: cstring): bool {.cdecl,
    importc: "TextIsEqual", dynlib: dynlibLibraryName.}
...
proc textToUtf8*(codepoints: ptr cint; length: cint): cstring {.cdecl,
    importc: "TextToUtf8", dynlib: dynlibLibraryName.}
##  Encode text codepoint into utf8 text (memory must be freed!)
##  UTF8 text strings management functions

proc getCodepoints*(text: cstring; count: ptr cint): ptr cint {.cdecl,
    importc: "GetCodepoints", dynlib: dynlibLibraryName.}
...
proc getNextCodepoint*(text: cstring; bytesProcessed: ptr cint): cint {.cdecl,
    importc: "GetNextCodepoint", dynlib: dynlibLibraryName.}
...
proc codepointToUtf8*(codepoint: cint; byteLength: ptr cint): cstring {.cdecl,
    importc: "CodepointToUtf8", dynlib: dynlibLibraryName.}
...
proc drawLine3D*(startPos: Vector3; endPos: Vector3; color: Color) {.cdecl,
    importc: "DrawLine3D", dynlib: dynlibLibraryName.}
...
proc drawMesh*(mesh: Mesh; material: Material; transform: Matrix) {.cdecl,
    importc: "DrawMesh", dynlib: dynlibLibraryName.}
...
proc unloadMesh*(mesh: Mesh) {.cdecl, importc: "UnloadMesh", dynlib: dynlibLibraryName.}
...
proc loadMaterials*(fileName: cstring; materialCount: ptr cint): ptr Material {.cdecl,
    importc: "LoadMaterials", dynlib: dynlibLibraryName.}
...
proc drawModel*(model: Model; position: Vector3; scale: cfloat; tint: Color) {.cdecl,
    importc: "DrawModel", dynlib: dynlibLibraryName.}
...
proc loadWaveFromMemory*(fileType: cstring; fileData: ptr uint8; dataSize: cint): Wave {.
    cdecl, importc: "LoadWaveFromMemory", dynlib: dynlibLibraryName.}
...
proc updateSound*(sound: Sound; data: pointer; samplesCount: cint) {.cdecl,
    importc: "UpdateSound", dynlib: dynlibLibraryName.}
##  Update sound buffer with new data

proc unloadWave*(wave: Wave) {.cdecl, importc: "UnloadWave", dynlib: dynlibLibraryName.}
##  Unload wave data
...
proc exportWaveAsCode*(wave: Wave; fileName: cstring): bool {.cdecl,
    importc: "ExportWaveAsCode", dynlib: dynlibLibraryName.}
##  Export wave sample data to code (.h), returns true on success
##  Wave/Sound management functions

proc playSound*(sound: Sound) {.cdecl, importc: "PlaySound", dynlib: dynlibLibraryName.}
##  Play a sound

proc stopSound*(sound: Sound) {.cdecl, importc: "StopSound", dynlib: dynlibLibraryName.}
...
proc stopSoundMulti*() {.cdecl, importc: "StopSoundMulti", dynlib: dynlibLibraryName.}
...
proc waveFormat*(wave: ptr Wave; sampleRate: cint; sampleSize: cint; channels: cint) {.
    cdecl, importc: "WaveFormat", dynlib: dynlibLibraryName.}
...
proc waveCrop*(wave: ptr Wave; initSample: cint; finalSample: cint) {.cdecl,
    importc: "WaveCrop", dynlib: dynlibLibraryName.}
...
proc loadMusicStreamFromMemory*(fileType: cstring; data: ptr uint8; dataSize: cint): Music {.
    cdecl, importc: "LoadMusicStreamFromMemory", dynlib: dynlibLibraryName.}
...
proc isAudioStreamProcessed*(stream: AudioStream): bool {.cdecl,
    importc: "IsAudioStreamProcessed", dynlib: dynlibLibraryName.}
...
proc isAudioStreamPlaying*(stream: AudioStream): bool {.cdecl,
    importc: "IsAudioStreamPlaying", dynlib: dynlibLibraryName.}
...
proc setAudioStreamVolume*(stream: AudioStream; volume: cfloat) {.cdecl,
    importc: "SetAudioStreamVolume", dynlib: dynlibLibraryName.}
##  Set volume for audio stream (1.0 is max level)

proc setAudioStreamPitch*(stream: AudioStream; pitch: cfloat) {.cdecl,
    importc: "SetAudioStreamPitch", dynlib: dynlibLibraryName.}
##  Set pitch for audio stream (1.0 is base level)

proc setAudioStreamBufferSizeDefault*(size: cint) {.cdecl,
    importc: "SetAudioStreamBufferSizeDefault", dynlib: dynlibLibraryName.}
